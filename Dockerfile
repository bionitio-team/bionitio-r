...
RUN apt-get update && apt-get install -y libssl-dev libxml2-dev libcurl4-openssl-dev libgit2-dev libssh2-1-dev libuv1-dev libfontconfig1-dev libharfbuzz-dev libfribidi-dev
